...
from pydantic.v1 import BaseSettings, Field, PostgresDsn, validator
...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = Field("Conta em Dia")
...
settings = Settings(_env_file=join(dirname(dirname(dirname(abspath(__file__)))), '.env.local'))
